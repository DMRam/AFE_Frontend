    ...
    return (
        <div className="fixed right-6 bottom-6 z-40">
            <div className="flex flex-col gap-3 items-center">
                {/* Connecting line for visual appeal */}
                <div className="h-8 w-0.5 bg-gradient-to-b from-gray-300/50 to-transparent"></div>
              ...
              `}
                        ...
                        >
                            {/* Tooltip on hover */}
                            <div className="absolute right-full mr-3 px-2.5 py-1.5 bg-gray-900 text-white text-xs font-medium rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                                {social.label}
                ...
                <div className="h-4 w-0.5 bg-gradient-to-t from-gray-300/30 to-transparent"></div>
            </div>
        </div>
    );
};